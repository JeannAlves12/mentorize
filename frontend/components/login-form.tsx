  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    if (tab === "login") {
      try {
        ...
        localStorage.setItem("name", user.name); // Salva nome correto vindo da API
        localStorage.setItem("role", user.role); // Salva role para uso futuro
      ...
      try {
        ...
        if (response.status === 201) {
          ...
          localStorage.setItem("token", access_token);
          localStorage.setItem("name", user.name); // Salva o nome vindo da API
          localStorage.setItem("role", user.role); // Salva o role vindo da API
